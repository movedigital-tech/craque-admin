...
export const turmaDetalheAlunos: TurmaAluno[] = [
  { name: 'Lucas Pereira', idade: '9 anos', resp: 'Marcos Pereira', pre: '92%', ok: true, st: 'paid' },
  { name: 'Pedro Henrique', idade: '9 anos', resp: 'Sandra Lima', pre: '95%', ok: true, st: 'paid' },
  { name: 'Bruno Dias', idade: '8 anos', resp: 'Carla Dias', pre: '70%', ok: false, st: 'late' },
  { name: 'Théo Moraes', idade: '9 anos', resp: 'Rita Moraes', pre: '88%', ok: true, st: 'paid' },
  { name: 'Gael Nunes', idade: '8 anos', resp: 'Ivo Nunes', pre: '83%', ok: false, st: 'pending' },
  { name: 'Vitor Reis', idade: '9 anos', resp: 'Lia Reis', pre: '97%', ok: true, st: 'paid' },
];
