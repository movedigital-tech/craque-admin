...
export function EscolinhaTurmas() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16 }}>
        ...
        <Button variant="primary" size="sm" leadingIcon="plus" onClick={() => navigate('/escolinha/turmas/novo')}>
          Nova turma
        </Button>
      </div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20 }}>
        {list.map((t) => {
          ...
          return (
            <Card key={t.nome} style={{ cursor: 'pointer' }} onClick={() => navigate('/escolinha/turmas/sub-9')}>
