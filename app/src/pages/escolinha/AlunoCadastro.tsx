...
export function EscolinhaAlunoCadastro() {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 300px', gap: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Button variant="primary" size="md" fullWidth leadingIcon="check" onClick={() => navigate('/escolinha/alunos')}>
              Salvar pré-cadastro
            </Button>
            <Button variant="secondary" size="md" fullWidth onClick={() => navigate('/escolinha/alunos')}>
              Cancelar
            </Button>
          </div>
        </div>
