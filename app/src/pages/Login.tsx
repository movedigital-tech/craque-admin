    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, background: 'var(--surface-canvas)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 48 }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <p style={{ margin: '0 0 32px', color: 'var(--text-secondary)', fontSize: 'var(--fs-body)' }}>Entre com sua conta de administrador.</p>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <Button variant="primary" size="lg" fullWidth leadingIcon="log-in" onClick={() => navigate('/dashboard')} style={{ marginTop: 6 }}>
              Entrar
            </Button>
          </div>
          <div
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: 'var(--fs-sm)', color: 'var(--text-secondary)', lineHeight: 1.6 }}>
              Acesso restrito ao time da plataforma. Convites em <strong>Usuários & Perfis</strong>.
            </p>
          </div>
        </div>
      </div>
