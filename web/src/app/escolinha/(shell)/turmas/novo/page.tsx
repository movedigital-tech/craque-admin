...
export default function EscolinhaTurmaCadastroPage() {
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 300px', gap: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <Button variant="primary" size="md" fullWidth leadingIcon="check" onClick={() => router.push('/escolinha/turmas')}>
              Salvar turma
            </Button>
            <Button variant="secondary" size="md" fullWidth onClick={() => router.push('/escolinha/turmas')}>
              Cancelar
            </Button>
          </div>
        </div>
